...
u = User.create(username: 'xuorig', email: 'mgiroux0@gmail.com', password: 'allo1234', profile_pic_url: 'http://mgiroux.me/assets/images/avatar@2x.png')
...
t = Team.create(name: 'The Dark Orchestra')
t.members << u
